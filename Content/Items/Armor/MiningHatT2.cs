...
namespace AdditionalMiningSets.Content.Items.Armor {
    ...
    public class MiningHatT2 : ModItem {
        ...
        public override bool IsArmorSet(Item head, Item body, Item legs) =>
            body.type == ModContent.ItemType<MiningShirtT2>() && legs.type == ModContent.ItemType<MiningPantsT2>();
        ...
        public override void AddRecipes() {
            // standard recipe, for if you already have ultrabright
            CreateRecipe()
            ...
            // note - dumped this recipe, reused the idea for T3 recipe
            CreateRecipe()
